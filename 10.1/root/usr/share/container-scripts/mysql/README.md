...
```
$ podman run -d --name mariadb_database -e MYSQL_USER=user -e MYSQL_PASSWORD=pass -e MYSQL_DATABASE=db -p 3306:3306 rhscl/mariadb-101-rhel7
```
...
available via `mariadb:10.1` imagestream tag in Openshift.
...
```
$ oc new-app mariadb:10.1~https://github.com/sclorg/mariadb-container.git \
...
```
$ s2i build --context-dir=examples/extend-image https://github.com/sclorg/mariadb-container.git rhscl/mariadb-101-rhel7 my-mariadb-rhel7
```
